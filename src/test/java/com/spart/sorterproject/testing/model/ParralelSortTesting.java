...
import com.sparta.sorterproject.model.ParallelArraySort;
...
public class ParralelSortTesting {
    ...
    @Test
    public void parallelArraySortOutputTestNormal(){
        ParallelArraySort parallelArraySortTest = new ParallelArraySort();
        int [] testArrNormal = {10,40,900,4,30,90,100};
        String arrTestString = Arrays.toString(testArrNormal);
        assertTrue(parallelArraySortTest.parallelArraysSort(testArrNormal).equals("[4, 10, 30, 40, 90, 100, 900]"));
    }
    // tests if an Array with two values that are the same
    @Test
    public void parallelArraySortOutputTestDuplicateValue(){
        ParallelArraySort parallelArraySortTest = new ParallelArraySort();
        int [] testArrNormal = {10,10,900,4,30,90,100};
        String arrTestString = Arrays.toString(testArrNormal);
        assertTrue(parallelArraySortTest.parallelArraysSort(testArrNormal).equals("[4, 10, 10, 30, 90, 100, 900]"));
    }

    // tests if an Array with all values the same
    @Test
    public void parallelArraySortOutputTestAllDuplicate(){
        ParallelArraySort parallelArraySortTest = new ParallelArraySort();
        int [] testArrNormal = {10,10,10,10,10,10,10};
        String arrTestString = Arrays.toString(testArrNormal);
        assertTrue(parallelArraySortTest.parallelArraysSort(testArrNormal).equals("[10, 10, 10, 10, 10, 10, 10]"));
    }
    ...
    public void parralelParralelArraySortOutputTestNegative(){
        ...
        String arrTestString = Arrays.toString(testArrNormal);
        assertTrue(parallelArraySortTest.parallelArraysSort(testArrNormal).equals("[-200, -106, -78, -10, -3, -2, 10]"));
    }
    ...
    public void parralelParralelArraySortOutputTestEmpty(){
        ...
        int [] testArrNormal = {};
        String arrTestString = Arrays.toString(testArrNormal);
        assertTrue(parallelArraySortTest.parallelArraysSort(testArrNormal).equals("[]"));
    }
    //Tests a very large Array of numbers
    @Test
    public void parallelParralelArraySortOutputTestLargeParralelArray(){
        ParallelArraySort parallelArraySortTest = new ParallelArraySort();
